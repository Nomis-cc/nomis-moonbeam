...
{
    /// <summary>
    /// Moonbeam wallet stats.
    /// </summary>
    public class MoonbeamWalletStats
        : IWalletStats
    {
        /// <summary>
        /// No data.
        ...
        /// <inheritdoc/>
        [Description("Wallet balance (GLMR)")]
        ...
        /// <inheritdoc/>
        [Description("The movement of funds on the wallet (GLMR)")]
        ...
        /// <inheritdoc/>
        [Description("NFT trading activity (GLMR)")]
        public decimal NftTrading { get; set; }

        /// <inheritdoc/>
        [Description("NFT worth on wallet (GLMR)")]
